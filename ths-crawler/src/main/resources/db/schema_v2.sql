...
CREATE TABLE IF NOT EXISTS industry_capital_flow (
    ...
    industry_link VARCHAR(300) DEFAULT NULL COMMENT '行业详情页URL',
    ...
    leading_stock_code VARCHAR(10) DEFAULT NULL COMMENT '领涨股代码',
    leading_stock_link VARCHAR(300) DEFAULT NULL COMMENT '领涨股详情页URL',
